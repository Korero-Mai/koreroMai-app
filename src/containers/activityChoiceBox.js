      ...
      <div className='activity-div'>
        ...
        <div className='row main'>
          <div className='columns small-centered small-10 medium-6 large-4'>
            <h3 className='h3-choose'>Learn to pronounce Te Reo</h3>
            <Link to="/activity/learn/sounds/1"><button className="choose">Letters and sounds</button></Link>
            ...
            <Link to="/activity/practice/sounds/1"><button className="choose">Letters and sounds</button></Link>
