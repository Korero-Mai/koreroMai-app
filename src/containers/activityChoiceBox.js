    ...
    return (
      <div className='row'>
        <div className='columns small-centered small-10 medium-6 large-4'>
          <h3>Learn</h3>
          <Link to="/activity/learn/sounds/1"><button className="button radius">Sounds</button><br /></Link>
          <Link to="activity/learn/words"><button className="button radius">Words</button><br /></Link>
          <h3>Practice</h3>
          <Link to="activity/practice/sounds"><button className="button radius">Sounds</button><br /></Link>
